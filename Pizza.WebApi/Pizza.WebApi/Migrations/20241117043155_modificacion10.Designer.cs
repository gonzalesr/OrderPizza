...
namespace Pizza.WebApi.Migrations
{
    ...
    [Migration("20241117043155_modificacion10")]
    partial class modificacion10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pizza.WebApi.Model.CustomPizzaDetail", b =>
                {
                    b.HasOne("Pizza.WebApi.Model.CustomPizzaRequest", "CustomPizzaRequest")
                    ...
                    b.HasOne("Pizza.WebApi.Model.Ingredient", "Ingredient")
                        .WithMany("CustomPizzaDetails")
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CustomPizzaRequest");
            ...
            modelBuilder.Entity("Pizza.WebApi.Model.Recipe", b =>
                {
                    ...
                    b.HasOne("Pizza.WebApi.Model.PizzaModel", "PizzaModel")
                        .WithMany("Recipes")
            ...
            modelBuilder.Entity("Pizza.WebApi.Model.Ingredient", b =>
                {
                    b.Navigation("CustomPizzaDetails");
